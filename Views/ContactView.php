<div class="contact" id="contact">
	...
	<div id="app" class="box" v-scroll="handleScroll">
		...
		<h4 class="anglais">Wanna get in touch? Write me here!</h4>
<p class="francais">Ou écrivez-moi à hello@aletharrias.com</p>
<p class="anglais">Or send a mail to hello@aletharrias.com</p>
		<form class="contactform" method="post" action="formulaire.php">
